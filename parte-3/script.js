const pageTemplates = {
    home: {
        ...
        <section class="hero" aria-labelledby="sobre-title">
            ...
            <figure>
            <img src="imagens/Voluntaria-ONG.jpg" alt="pessoa cercada por cães" width="400">
        ...
        <section aria-labelledby="adote-title">
            ...
            <p><a href="/cadastro" class="btn btn-cta" data-nav-link>Ir para o formulário de cadastro</a></p>
        </section>
        `,
    },
    projects: {
        ...
        <section class="projects" aria-labelledby="projetos-title">
            ...
            <figure>
                <img src="imagens/voluntarios-ong.jpg" alt="Voluntária cuidando de um cão">
            ...
            <ol>
                <li>Preencha o formulário de <a href="/cadastro" data-nav-link>cadastro</a>.</li>
    ...
    register: {
        ...
        main: `
        <figure>
            <img src="imagens/adocao-ONG.jpg" alt="cães filhotes para adoção">
    ...
    notFound: {
        ...
        main: `<section class="text-center"><h2>Erro 404</h2><p>A página que você está procurando não existe.</p><p><a href="/" class="btn" data-nav-link>Voltar ao Início</a></p></section>`,
    },
};
...
const spaRouter = {
    ...
    routes: { '/': 'home', '/projetos': 'projects', '/cadastro': 'register', '/index.html': 'home' },
